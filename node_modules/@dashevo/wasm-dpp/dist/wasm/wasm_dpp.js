...
* @returns {any}
*/function deserializeConsensusError(bytes){try{const retptr=wasm.__wbindgen_add_to_stack_pointer(-16);const ptr0=passArray8ToWasm0(bytes,wasm.__wbindgen_malloc);const len0=WASM_VECTOR_LEN;wasm.deserializeConsensusError(retptr,ptr0,len0);var r0=getInt32Memory0()[retptr/4+0];var r1=getInt32Memory0()[retptr/4+1];var r2=getInt32Memory0()[retptr/4+2];if(r2){throw takeObject(r1);}return takeObject(r0);}finally{wasm.__wbindgen_add_to_stack_pointer(16);}}function __wbg_adapter_1555(arg0,arg1,arg2,arg3){wasm.wasm_bindgen__convert__closures__invoke2_mut__h76e8fde4fe4f4ccd(arg0,arg1,addHeapObject(arg2),addHeapObject(arg3));}/**
...
*/exports.ChainAssetLockProof=ChainAssetLockProof;class ContestedUniqueIndexOnMutableDocumentTypeError{static __wrap(ptr){ptr=ptr>>>0;const obj=Object.create(ContestedUniqueIndexOnMutableDocumentTypeError.prototype);obj.__wbg_ptr=ptr;return obj;}__destroy_into_raw(){const ptr=this.__wbg_ptr;this.__wbg_ptr=0;return ptr;}free(){const ptr=this.__destroy_into_raw();wasm.__wbg_contesteduniqueindexonmutabledocumenttypeerror_free(ptr);}/**
    * @returns {number}
